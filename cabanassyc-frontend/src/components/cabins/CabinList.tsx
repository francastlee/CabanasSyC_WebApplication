...
export default function CabinList() {
  ...
  return (
    <section className="relative py-50 px-4 bg-[#1a3a17] min-h-screen select-none overflow-hidden lg:py-16">
      <div className="absolute top-0 left-0 w-full h-40 bg-gradient-to-b from-[#4B2A1F] to-transparent pointer-events-none z-10" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12 px-4 mx-auto max-w-screen-xl mt-10 xl:mb-50 z-20 relative">
